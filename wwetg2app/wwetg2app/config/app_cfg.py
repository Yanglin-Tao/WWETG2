# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in wwetg2app.
...
import wwetg2app
from wwetg2app import model, lib
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': wwetg2app.model,
    'DBSession': wwetg2app.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "b7f6d6c6-b64d-4322-8136-129a65f9fd72",
